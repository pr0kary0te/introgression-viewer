...
# Update the index. It is used in the selectbox.
    # st.session_state.index = st.session_state.genome.index(st.session_state.ref)
        ...
        refFiles = {'Arina': ['https://www.cerealsdb.uk.net/aliensArina.csv.gz', '_WhAri'],
                    'Chinese Spring': ['https://www.cerealsdb.uk.net/aliensChineseSpring.csv.gz', ''],
                    'Jagger': ['https://www.cerealsdb.uk.net/aliensJagger.csv.gz', '_WhJag'],
                    'Julius': ['https://www.cerealsdb.uk.net/aliensJulius.csv.gz', '_Whjul'],
                    'Lancer': ['https://www.cerealsdb.uk.net/aliensLancer.csv.gz', '_Whlan'],
                    'Landmark': ['https://www.cerealsdb.uk.net/aliensLandmark.csv.gz', '_WhLan'],
                    'Mace': ['https://www.cerealsdb.uk.net/aliensMace.csv.gz', '_Whmac'],
                    'Norin61': ['https://www.cerealsdb.uk.net/aliensNoring61.csv.gz', '_WhNor'],
                    'Spelt': ['https://www.cerealsdb.uk.net/aliensSpelta.csv.gz', '_Whspe'],
                    'Stanley': ['https://www.cerealsdb.uk.net/aliensStanley.csv.gz', '_WhSta'],
                    'Mattis': ['https://www.cerealsdb.uk.net/aliensMattis.csv.gz', '_WhSYM']
                    }
