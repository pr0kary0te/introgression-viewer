...
with st.sidebar:
    ...
    filePath = refFiles[st.session_state['ref']][0]    
...
SeriesSumSorted = SeriesSumSorted.drop(labels = ['AdjustedBin', 'Lo7_nuq'])
...
with col1:
    ...
    with col1a:
        ...
        choice1 = st.number_input('Top figure', value=3, min_value=0, key='Choice1')
        choice3 = st.number_input('Bottom figure', value=1, min_value=0, key='Choice3')
        
    with col1b:
        
        choice2 = st.number_input('Top figure', label_visibility='hidden', value=6, min_value = 0, key = 'Choice2')
...
#     # var1 = SeriesSumSorted.index[3]
#     # var2 = SeriesSumSorted.index[6]
    
#     # choice1 = st.number_input('Select number from above table', value=3, min_value=0, key='Choice1')
#     # choice2 = st.number_input('Select number from above table', value=4, min_value=0, key='Choice2')

    var1 = SeriesSumSorted.index[choice1]
    var2 = SeriesSumSorted.index[choice2]

    st.markdown(f'<p class="font2">{var1} vs {var2}</p>', unsafe_allow_html=True)
    ...
    # choice3 = st.number_input('Select number from above table', value=-3, min_value = 0, key = 'Choice3')
    # choice4 = st.number_input('Select number from above table', value= 6, min_value = 0, key = 'Choice4')

    var3 = SeriesSumSorted.index[choice3]
    var4 = SeriesSumSorted.index[choice4]

    st.markdown(f'<p class="font2">{var3} vs {var4}</p>', unsafe_allow_html=True)
